...
-- "ALTER TABLE DEPARTMENTS DROP CONSTRAINT  DEPT_MGR_FK ;" (= Oracle code)
-- Because table DEPARTMENTS has a foreign key to table EMPLOYEES
-- AND     table EMPLOYEES   has a foreign key to table DEPARTMENTS
-- neither of both tables can be dropped.
-- This is why we want to drop one of both foreign key constraints.

-- MySQL Solution 1: 
-- ALTER TABLE DEPARTMENTS DROP FOREIGN KEY DEPT_MGR_FK ;
-- so we can drop table EMPLOYEES, and afterwards we can drop table DEPARTMENTS.
-- Inconvenient: In the case the FK doesnt exist yet, "ALTER TABLE ... DROP FOREIGN KEY" throws an error code.

-- MySQL Solution 2:
-- Temporarily suspend (ignore) foreign key constraints by setting foreign_key_checks = 0.
...
CREATE TABLE  WF_COUNTRIES
   ( COUNTRY_ID  REAL(4,0), 
	 ...
	 AREA  REAL(15,0), 
	 COASTLINE  REAL(8,0), 
	 LOWEST_ELEVATION  REAL(6,0), 
	 LOWEST_ELEV_NAME  VARCHAR(70), 
	 HIGHEST_ELEVATION  REAL(6,0), 
	 ...
	 POPULATION  REAL(12,0), 
	 POPULATION_GROWTH_RATE  VARCHAR(10), 
	 LIFE_EXPECT_AT_BIRTH  REAL(6,2), 
	 MEDIAN_AGE  REAL(6,2), 
	 AIRPORTS  REAL(6,0), 
...
CREATE TABLE   F_FOOD_ITEMS 
   ( FOOD_ITEM_NUMBER  REAL(5,0),
     DESCRIPTION  VARCHAR(100) NOT NULL,
     PRICE  REAL(8,2) NOT NULL,
...
CREATE TABLE   F_STAFFS 
   ( ID  REAL(5,0),
     ...
     SALARY  REAL(8,2) NOT NULL,
     OVERTIME_RATE  REAL(5,2),
     TRAINING  VARCHAR(50),
     STAFF_TYPE  VARCHAR(20) NOT NULL,
     MANAGER_ID  REAL(5,0),
     MANAGER_BUDGET  REAL(8,2),
     MANAGER_TARGET  REAL(8,2),
     CONSTRAINT  F_STF_ID_PK  PRIMARY KEY ( ID )
  
   );

CREATE TABLE   F_ORDERS 
   ( ORDER_NUMBER  REAL(5,0),
     ORDER_DATE  DATE NOT NULL,
     ORDER_TOTAL  REAL(8,2),
     CUST_ID  REAL(5,0) NOT NULL,
     STAFF_ID  REAL(5,0) NOT NULL,
...
CREATE TABLE   D_CLIENTS 
   ( CLIENT_NUMBER  REAL(5,0),
     FIRST_NAME  VARCHAR(25) NOT NULL,
     LAST_NAME  VARCHAR(30) NOT NULL,
     PHONE  REAL(15,0) NOT NULL,
     EMAIL  VARCHAR(50),
...
CREATE TABLE   D_PACKAGES 
   ( CODE  REAL(10,0),
     LOW_RANGE  REAL(6,0) NOT NULL,
     HIGH_RANGE  REAL(6,0) NOT NULL,
...
CREATE TABLE   D_EVENTS 
   ( ID  REAL(5,0),
     ...
     COST  REAL(8,2) NOT NULL,
     VENUE_ID  REAL(5,0) NOT NULL,
     PACKAGE_CODE  REAL(5,0) NOT NULL,
     THEME_CODE  REAL(10,0) NOT NULL,
     CLIENT_NUMBER  REAL(5,0) NOT NULL,
